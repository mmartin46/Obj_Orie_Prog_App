...
class ChainScreen(Screen):
   ...
   def on_enter(self, *args):
      ...
      self.title_label.text=self.db.get_query("""SELECT p_name FROM all_patterns WHERE p_name LIKE 'Chain%'""")
   ...
   #   self.main_lout.spacing=3
      ...
      self.desc_label.text = str(GetDesignDesc('Chain').java_design_desc())
      ...
      self.img = Image(source='code_imgs\\chain_0.PNG')
      self.img.pos_hint={'center_x': 0.5, 'center_y': 0.77}
      self.img.size_hint_y=.8
      self.img.size_hint_x=.8
      self.bk_drop.add_widget(self.img)
            
      self.img_2 = Image(source='code_imgs\\chain_1.PNG')
      self.img_2.pos_hint={'center_x': 0.5, 'center_y': 0.5}
      self.img_2.size_hint_y=.8
      self.img_2.size_hint_x=.8
      self.bk_drop.add_widget(self.img_2)

      self.img_3 = Image(source='code_imgs\\chain_2.PNG')
      self.img_3.pos_hint={'center_x': 0.5, 'center_y': 0.33}
      self.img_3.size_hint_y=.8
      self.img_3.size_hint_x=.8
      self.bk_drop.add_widget(self.img_3)

      self.img_4 = Image(source='code_imgs\\chain_4.PNG')
      self.img_4.pos_hint={'center_x': 0.5, 'center_y': 0.13}
