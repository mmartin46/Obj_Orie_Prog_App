...
class CompositeScreen(Screen):
   ...
   def on_enter(self, *args):
      ...
      self.title_label.text=self.db.get_query("""SELECT p_name FROM all_patterns WHERE p_name LIKE 'Composite%'""")
   ...
   #   self.main_lout.spacing=3
      ...
      self.desc_label.text = str(GetDesignDesc('Composite').java_design_desc())
      ...
      self.img_3 = Image(source='code_imgs\\composite_2.PNG')
      ...
      self.img_4 = Image(source='code_imgs\\composite_3.PNG')
