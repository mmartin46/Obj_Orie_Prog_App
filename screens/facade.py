...
class FacadeScreen(Screen):
   ...
   def on_enter(self, *args):
      ...
      self.title_label.text=self.db.get_query("""SELECT p_name FROM all_patterns WHERE p_name LIKE 'Facade%'""")
   ...
   #   self.main_lout.spacing=3
      ...
      self.desc_label.text = str(GetDesignDesc('Facade').java_design_desc())
      ...
      self.img_3 = Image(source='code_imgs\\facade_2.PNG')
      ...
      self.img_4 = Image(source='code_imgs\\facade_3.PNG')
