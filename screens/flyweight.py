...
class FlyWeightScreen(Screen):
   ...
   def on_enter(self, *args):
      ...
      self.title_label.text=self.db.get_query("""SELECT p_name FROM all_patterns WHERE p_name LIKE 'Flyweight%'""")
   ...
   #   self.main_lout.spacing=3
      ...
      self.desc_label.text = str(GetDesignDesc('Flyweight').java_design_desc())
      ...
      self.img_3 = Image(source='code_imgs\\flyweight_2.PNG')
