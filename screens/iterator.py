...
class IteratorScreen(Screen):
   ...
   def on_enter(self, *args):
      ...
      self.title_label.text=self.db.get_query("""SELECT p_name FROM all_patterns WHERE p_name LIKE 'Iterator%'""")
   ...
   #   self.main_lout.spacing=3
      ...
      self.desc_label.text = str(GetDesignDesc('Iterator').java_design_desc())
      ...
      self.img_3 = Image(source='code_imgs\\iterator_2.PNG')
      ...
      self.img_4 = Image(source='code_imgs\\iterator_3.PNG')
