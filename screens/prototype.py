...
class PrototypeScreen(Screen):
   ...
   def on_enter(self, *args):
      ...
      self.title_label.text=self.db.get_query("""SELECT p_name FROM all_patterns WHERE p_name LIKE 'Prototype%'""")
   ...
   #   self.main_lout.spacing=3
      ...
      self.desc_label.text = str(PrototypeDesc().java_design_desc())
      ...
      self.img = Image(source='code_imgs\\prototype_0.PNG')
      self.img.pos_hint={'center_x': 0.5, 'center_y': 0.65}
