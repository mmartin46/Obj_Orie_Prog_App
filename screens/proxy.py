...
class ProxyScreen(Screen):
   ...
   def on_enter(self, *args):
      ...
      self.title_label.text=self.db.get_query("""SELECT p_name FROM all_patterns WHERE p_name LIKE 'Proxy%'""")
   ...
   #   self.main_lout.spacing=3
      ...
      self.desc_label.text = str(GetDesignDesc('Proxy').java_design_desc())
      ...
      self.img_3 = Image(source='code_imgs\\proxy_2.PNG')
      self.img_3.pos_hint={'center_x': 0.5, 'center_y': 0.23}
