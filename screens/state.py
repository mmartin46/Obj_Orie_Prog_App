...
class StateScreen(Screen):
   ...
   def on_enter(self, *args):
      ...
      self.title_label.text=self.db.get_query("""SELECT p_name FROM all_patterns WHERE p_name LIKE 'State%'""")
   ...
   #   self.main_lout.spacing=3
      ...
      self.desc_label.text = str(GetDesignDesc('State').java_design_desc())
      ...
      self.img_3 = Image(source='code_imgs\\state_2.PNG')
      ...
      self.img_4 = Image(source='code_imgs\\state_3.PNG')
      ...
      self.img_5 = Image(source='code_imgs\\state_4.PNG')
      self.img_5.pos_hint={'center_x': 0.5, 'center_y': .09}
