...
class StrategyScreen(Screen):
   ...
   def on_enter(self, *args):
      ...
      self.title_label.text=self.db.get_query("""SELECT p_name FROM all_patterns WHERE p_name LIKE 'Strategy%'""")
   ...
   #   self.main_lout.spacing=3
      ...
      self.desc_label.text = str(GetDesignDesc('Strategy').java_design_desc())
      ...
      self.img_3 = Image(source='code_imgs\\strategy_2.PNG')
      self.img_3.pos_hint={'center_x': 0.5, 'center_y': .50}
      self.img_3.size_hint_y=.8
      self.img_3.size_hint_x=.8
      self.bk_drop.add_widget(self.img_3)

      self.img_4 = Image(source='code_imgs\\strategy_3.PNG')
      ...
      self.img_5 = Image(source='code_imgs\\strategy_4.PNG')
      self.img_5.pos_hint={'center_x': 0.5, 'center_y': .19}
      self.img_5.size_hint_y=.7
      self.img_5.size_hint_x=.7
